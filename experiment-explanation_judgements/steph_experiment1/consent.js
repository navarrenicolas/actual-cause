    ...
    stimulus: `
      <div id="ConsentStyle">
        ...
        <p><b>Voluntary participation and right to withdraw.</b> Your participation is voluntary, and you may withdraw 
            from the study at any time and for any reason. If you withdraw from the study during or after data gathering, 
            we will delete your data and there is no penalty; however, you will <b>not</b> receive payment. As data is 
            anonymized, it is not possible to withdraw after the data gathering is finished.</p>
        ...
        <p>If you have any questions about what you've just read, please feel free to ask or contact us later. You
            ...
            <a href="mailto:s2016170@ed.ac.uk">s2016170@ed.ac.uk</a>. This project has been approved by PPLS Ethics Committee, RT number 243-2425/1. 
