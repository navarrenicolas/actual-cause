/**
 * lORe
 * a jspsych plugin for Lawyers vs Engineers type of problems
 *
 * Mathias Sablé-Meyer
 *
 */
...
jsPsych.plugins['lORe'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
        ...
        tbl.id = "tbl";
        tbl.style.border = "solid 2px rgba(1,1,1,1)";
        ...
        for (var e = 0; e < total ; e++) {
            ...
            if ((e + 1) % trial.geometryX === 0) {
                e < total_top ? tbdy.appendChild(tr) : tbdy.appendChild(tr);
                tr = document.createElement('tr');
            }
            if (e === total - 1) {
                tbdy.appendChild(tr);
